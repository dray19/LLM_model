...
from rag_multi_query import LLMPredictorRAG_MultiQuery
from utils import *
...
def evaluate_model(test_file, output_csv):
    ...
    # Initialize the predictor
    predictor = LLMPredictorRAG_MultiQuery()
    predictor.set_documents(code_docs)
    ...
    for i, test in enumerate(test_cases):
        ...
        try:
            # Generate response
            response = predictor.generate_response_rag(test["messages"][1]['content'])
...
if __name__ == "__main__":
    ...
    test_file_path = "/Users/drazenzack/Desktop/LLM_model/data/unseen.jsonl"

    # Path to save the results CSV file
    output_csv_path = "/Users/drazenzack/Desktop/LLM_model/Model_Results/unseen_test_results_rag_MultiQuery_update.csv"
